public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(facade.addNews(1, "Сегодня 1-е число", "DataNews", "Ilya", "Date today"));
        System.out.println(facade.addNews(2, "Сегодня 2-е число", "DataNews", "Ilya", "Date today"));
        System.out.println(facade.addNews(3, "Сегодня 3-е число", "DataNews", "Ilya", "Date today"));
        System.out.println(facade.addNews(4, "Сегодня 4-е число", "DataNews", "Gleb", "Date today"));

        System.out.println(facade.getAllNews());
        System.out.println(facade.getOneNews(1));
        System.out.println(facade.delNews(3));

        System.out.println(facade.getAllNews());

        System.out.println(facade.getShortData(2));
